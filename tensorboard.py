...
tf.summary.histogram("w_h2,summ", w_h2)
...
with tf.Session() as sess:
	#Step 10 - Create a log writter. run 'tesorboard --logdir=./logs/nn_logs'
	writer = tf.summary.FileWriter("./logs/nn_logs", sess.graph)
	merged = tf.summary.merge_all()

#Step 11 initialize all variables
